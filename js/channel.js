    ...
    var harga = '';
        ...
        if (jQuery.inArray(temp[1], sapuluh.split(','))!='-1') {
          ...
          output = '<li class="maindiv"><div><span class="harga">'+harga+'</span>' +
                        ...
                        '<img class="beli" src="beli-wa.png" onclick="https://web.whatsapp.com/send?phone=620896-1888-5066&text=Halo%20Admin..%20saya%20mau%20order%20video%20tema:%20*'+videTitle+'*%0A%0A%0A_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%0A%0A*Metode%20Pembayaran%20:*%0ATransfer%20Pulsa%0A08992021330%20(Tri)%0A%0A"/></div>' +
                        '<div>' +
