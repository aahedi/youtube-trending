    ...
    var harga = '';
        ...
        if (jQuery.inArray(temp[1], sapuluh.split(','))!='-1') {
          ...
          output = '<li class="maindiv"><div><span class="harga">'+harga+'</span>' +
                        ...
                        '<a href="https://api.whatsapp.com/send?phone=62895800708788&text=Halo%20Admin..%20saya%20mau%20order%20video%20%0ATema:%20*'+videTitle+'*%0A%20Harga:%20*'+harga+'*%0A%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%20_%0A%0A*Metode%20Pembayaran%20:*%0ATransfer%20Pulsa%0A08992021330%20(Tri)%0A%0A" target="_blank"><img class="beli" src="beli-wa.png"/></a></div>' +
                        '<div>' +
